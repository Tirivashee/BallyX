    ...
    <section className="relative overflow-hidden border-b border-ink/10">
      ...
      <Container className="relative py-24 md:py-32">
        ...
        <p className="mt-6 max-w-xl text-lg leading-relaxed text-ink-soft">
          {brand.shortName} is a focused software studio building custom
          business systems and Pluto — a local-first point-of-sale platform
          designed for the way African SMEs actually trade.
        </p>
